...
public class LabController {
    ...
    public View create_post(Form form) throws IOException {
        long postid = postService.createPost(form.getCreater(), form.getTopic(),
                form.getBody(), form.getAttachments(), form.getCreateddate(), "lab");

        return new RedirectView("/forum/lab/", true);

    }
    
    @GetMapping("{postid}/reply")
    public String reply(@PathVariable("postid") long postid, ModelMap model) {
